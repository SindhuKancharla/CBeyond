...
public class GetCreoleControllerForDescParsing {
	...
	public static CorpusController createController() throws GateException, IOException {
		...
		paramsg.put("listsURL", new File("resources/Rules/descFeatures.def").toURI().toURL());  
		...
		params.put("grammarURL", new File("resources/Rules/MainFeatureExt.jape").toURI().toURL());  
		ProcessingResource transducer = (ProcessingResource)Factory.createResource(  
		     "gate.jape.plus.Transducer", params);
	
	/*	FeatureMap params = Factory.newFeatureMap();  
		params.put("grammarURL", new File("resources/Rules/getNames.jape").toURI().toURL());  
		ProcessingResource transducer = (ProcessingResource)Factory.createResource(  
