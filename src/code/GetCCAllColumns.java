...
public class GetCCAllColumns {
	...
	public static CorpusController createController() throws GateException, IOException {
		...
		paramsg.put("listsURL", new File("resources/Rules/featureTypesGaz.def").toURI().toURL());  
		...
		params.put("grammarURL", new File("resources/Rules/MainDetailsExtract.jape").toURI().toURL());  
